@extends('front-end.template.login')
@section('content')
    <!-- Log In page -->
                    ...
                    <div class="px-3">
                        <div class="media">
                            ...
                            <div class="media-body ml-3 align-self-center">
                                <h4 class="mt-0 mb-1">Login on Spending</h4>
                                <p class="text-muted mb-0">Sign in to continue to Spending.</p>
                            </div>
                        </div>

                        <form class="form-horizontal my-4" method="POST" action="{{route('login.check')}}">
                            @csrf
...
{{--                        <p class="font-13">Join <span>Spending</span> Now</p>--}}
        ...
        <div class="col-lg-9 p-0 d-flex justify-content-center">
            <div class="accountbg d-flex align-items-center">
                <div class="account-title text-white text-center">
                    ...
                    <h4 class="mt-3">Welcome To App Spendings</h4>
